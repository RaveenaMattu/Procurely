...
const LandingPage = () => {
  ...
  const CheckIcon = () => (
    <svg width="31" height="32" viewBox="0 0 31 32" fill="none">
      <path d="M12.9167 21.8666L7.75 16.5333L9.55833 14.6666L12.9167 18.1333L21.4417 9.33331L23.25 11.2L12.9167 21.8666Z" fill="#FFE66D"/>
    </svg>
  );

  const ArrowIcon = () => (
    <svg width="52" height="46" viewBox="0 0 52 46" fill="none">
      <path d="M34.61 24.9166H8.80078V21.0833H34.61L22.7388 10.35L25.7596 7.66663L42.7185 23L25.7596 38.3333L22.7388 35.65L34.61 24.9166Z" fill="#1D1B20"/>
    </svg>
  );

  const SearchIcon = () => (
    <svg width="42" height="42" viewBox="0 0 84 84" fill="none">
      <path d="M35 56C47.1503 56 57 46.1503 57 34C57 21.8497 47.1503 12 35 12C22.8497 12 13 21.8497 13 34C13 46.1503 22.8497 56 35 56Z" stroke="#1E1E1E" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M49.5859 49.586L64.9999 65" stroke="#1E1E1E" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );

  const CartIcon = () => (
    <svg width="43" height="48" viewBox="0 0 43 48" fill="none">
      <path d="M2.625 2H9.625L14.315 28.78C14.475 29.7008 14.9133 30.5279 15.5532 31.1166C16.1931 31.7053 16.9937 32.018 17.815 32H34.825C35.6463 32.018 36.4469 31.7053 37.0868 31.1166C37.7267 30.5279 38.165 29.7008 38.325 28.78L41.125 12H11.375M18.375 42C18.375 43.1046 17.5915 44 16.625 44C15.6585 44 14.875 43.1046 14.875 42C14.875 40.8954 15.6585 40 16.625 40C17.5915 40 18.375 40.8954 18.375 42ZM37.625 42C37.625 43.1046 36.8415 44 35.875 44C34.9085 44 34.125 43.1046 34.125 42C34.125 40.8954 34.9085 40 35.875 40C36.8415 40 37.625 40.8954 37.625 42Z" stroke="#1E1E1E" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );

  const FileIcon = () => (
    <svg width="43" height="46" viewBox="0 0 43 46" fill="none">
      <path d="M25 4.65942H11C10.0717 4.65942 9.1815 5.05538 8.52513 5.76019C7.86875 6.46499 7.5 7.42092 7.5 8.41767V38.4836C7.5 39.4804 7.86875 40.4363 8.52513 41.1411C9.1815 41.8459 10.0717 42.2418 11 42.2418H32C32.9283 42.2418 33.8185 41.8459 34.4749 41.1411C35.1313 40.4363 35.5 39.4804 35.5 38.4836V15.9342M25 4.65942L35.5 15.9342M25 4.65942V15.9342H35.5M28.5 25.3298H14.5M28.5 32.8462H14.5M18 17.8133H14.5" stroke="black" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
  ...
  const StarIcon = () => (
    <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
      <path d="M28.0001 4.6665L35.2101 19.2732L51.3334 21.6298L39.6667 32.9932L42.4201 49.0465L28.0001 41.4632L13.5801 49.0465L16.3334 32.9932L4.66675 21.6298L20.7901 19.2732L28.0001 4.6665Z" fill="#FFE66D"/>
    </svg>
  );
  ...
  return (
    <div className="landing-page">
      ...
      <section className="testimonials-section">
        <h2 className="testimonials-title">What Our Users Say About Procurely?</h2>
        ...
        <div className="testimonials-container-wrapper">
          <div className="testimonials-container">
            ...
            <div className="testimonial-card">
              ...
              <p className="testimonial-text">
                Fusce a libero efficitur, sollicitudin odio in, tempor magna. Morbi vel lorem at elit pharetra malesuada.
              </p>
              <div className="testimonial-author">
                <div className="author-avatar">
                  <img
